...
class Enviroment():
    ...
    def step(self, action):
        ...
        self.ever.img_D_star = np.zeros([500, 500], dtype=np.uint8)
        mask = ((self.ever.img[:, :, 0] == 255) | (self.ever.img[:, :, 0] == 0)) \
               & (self.ever.img[:, :, 1] == 0) & (self.ever.img[:, :, 2] == 0)
        self.ever.img_D_star[mask] = 255
